        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <ul className="list-disc list-inside text-pretty text-sm">
              <li>
                20+ hooks for working with wallets, ENS, contracts,
                transactions, signing, etc.
              </li>
              <li>
                Built-in wallet connectors for MetaMask, WalletConnect, Coinbase
                Wallet, Injected, and more
              </li>
              <li>
...
function LogoWagmi() {
  return (
    <svg
      ...
      className="fill-current h-full max-w-[250px] mx-auto"
    >
